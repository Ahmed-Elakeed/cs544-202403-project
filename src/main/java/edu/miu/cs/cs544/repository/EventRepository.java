...
public interface EventRepository extends BaseRepository<Event, Long> {
    ...
    @Transactional
    @Modifying
    @Query(value = "delete from member_sessions ms where ms.session_id = :sessionId", nativeQuery = true)
    void deleteAllSessionMemberRecords(@Param(value = "sessionId") Long sessionId);
}
